...
This guide walks you through the process of creating a SOAP-based web service server with Spring in Weblogic 12c.

Application WSDL deploys to http://localhost:7001/gs-producing-web-service/ws/countries.wsdl
